...
class GOBall extends GameObject
{
	...
	void Stop()
	{
		stateY = GOStateVertical.STOP;
		stateX = GOStateHorizontal.STOP;
	}
	...
	GOStateHorizontal getStateX()
	{
		return stateX;
	}

	GOStateVertical getStateY()
	{
		return stateY;
	}

	private int getExactSpeedX()
	{
